...
const NewsItem = (props)=> {
    ...
    <div className='mx-3 my-3'>
        <div className="card">
            ...
            <img src={imageUrl ? imageUrl : "https://images.moneycontrol.com/static-mcnews/2023/05/Spinach-Best-food-for-hair-growth-770x433.jpg"} className="card-img-top" alt="..."/>
